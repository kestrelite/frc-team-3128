...
All of the information about the introductory tasks is located in \lstinline{latex/Programming Tasks.pdf}, though the (slightly outdated) text files are in each subdirectory as well.

There are five subsections in the intro folder. Each subsection contains its own tasks. The files with the introductory tasks are located within the folders; for instance, task 01 is at: \lstinline{intro/01 - Basic Usage/01 - DebugLog usage.txt}
