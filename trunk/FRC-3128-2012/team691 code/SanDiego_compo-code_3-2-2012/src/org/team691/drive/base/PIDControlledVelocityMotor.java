package org.team691.drive.base;
...
public class PIDControlledVelocityMotor
{
     ...
     */
    public static final double DEFAULT_UPDATES_PER_SECOND = 25.0; // was 50.0
    ...
    {
        return ( "------------------------------------------------\n"
                 + "Encoder Location: " + encoderCount + "/n" + "Current Velociy: "
                 + currentVelocity + "/n" + "Target Velocity: " + targetVelocity + "\n"
