 ...
 */
package org.team691.drive.swerve;
...
public class SwerveDrive implements Drive
{
    ...
    public void update(double Y, double X, double T)
    {
        ...
        */
        ...
        if ( T != 0.0 )
        {
            ...
            /*
             * fr.setTargetAngle(  DEFAULT_TURN_FR  );
             * fl.setTargetAngle(  DEFAULT_TURN_FL  );
             * bl.setTargetAngle(  DEFAULT_TURN_BL  );
             * br.setTargetAngle(  DEFAULT_TURN_BR  );
             */
            fr.update();
            fl.update();
            bl.update();
    ...
    {
        return ( Mathf.abs( value ) > ERROR ) ? value : 0;
    }
    */
}
